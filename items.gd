...
var herring = item.new(3,"Pickeled Herring",types.crop, 100, 400, preload("res://Sprites/UI/fish_icon.png"))
var herring_seed = item.new(4,"Regular Old Herring",types.seed, 200, 50, preload("res://Sprites/Plants/Fish/fish_1.png"))
